...
export const zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      windowsInsertionModeDesc: '听写结果如何插入到当前光标位置。剪贴板粘贴模式使用上方「模拟粘贴快捷键」，可完整保留换行。',
      ...
      windowsSendInputNewlineModeDesc: 'SendInput 模式下如何把换行符模拟成按键。聊天框通常选 Shift+Enter；记事本 / VS Code 等选 Enter。',
    ...
    about: {
      ...
      autoUpdateCheckDescAndroid: '启动后及每 60 分钟自动检查更新；发现新版本后自动下载并打开系统安装器。渠道跟随上方 Beta 开关。',
